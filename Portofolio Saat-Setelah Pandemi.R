...
portfolio_values %>%
  ...
  labs(x = 'Risk',
       y = 'Returns',
       title = "Portfolio Optimization & Efficient Frontier Saat - Setelah Pandemi") +
...
write.csv(portfolio_values, file = "C:\\Users\\Hasan Zein\\Downloads\\portfolio_values Saat - Setelah.csv")